...
Current detectors cover common JavaScript/TypeScript, Python, Ruby, PHP, Rust, Go, and monorepo repositories:

- package manager: npm, pnpm, yarn, bun, pip, bundler, composer, cargo, go
...
- frameworks/tools: React, Vite, Next.js, Next.js App Router, Vue, Nuxt, Astro, Svelte, SvelteKit, Express, NestJS, Playwright, Storybook, FastAPI, Django, Flask, Pytest, Rails, Laravel, Rust web frameworks, Gin, Docker, Docker Compose
