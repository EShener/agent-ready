...
[Showcase](docs/showcase.md) · [Examples](docs/examples/README.md) · [Detectors](docs/detectors.md) · [Benchmark](BENCHMARK.md) · [Publishing](docs/npm-publishing.md) · [Growth playbook](docs/growth-playbook.md) · [Outreach automation](docs/outreach-automation.md) · [Launch kit](docs/launch-kit.md) · [Launch notes](LAUNCH.md)
...
- package manager: npm, pnpm, yarn, bun, pip, Poetry, PDM, uv, bundler, composer, dotnet, maven, gradle, cargo, go
